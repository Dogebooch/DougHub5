...
export function QuickActionsBar({ onOpenQuickDump }: QuickActionsBarProps) {
  ...
  return (
    <div className="border-b border-black/30 bg-background/50 backdrop-blur-sm shadow-sm">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-5">
            <Button
              variant="default"
              size="lg"
              className="min-h-[52px] px-8 font-serif font-bold text-lg shadow-[0_10px_20px_-5px_rgba(0,0,0,0.4)] hover:shadow-primary/20 transition-all rounded-xl"
            ...
            <Button
              variant="outline"
              size="lg"
              className="min-h-[52px] px-8 gap-3 border-black/20 bg-black/20 hover:bg-black/40 font-serif font-semibold text-lg transition-all rounded-xl"
