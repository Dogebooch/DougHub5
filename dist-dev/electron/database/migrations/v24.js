...
exports.migrateToV24 = migrateToV24;
...
function migrateToV24() {
    ...
    `);
        ...
        const existingBlocks = database
            .prepare(`SELECT id, notebookTopicPageId FROM notebook_blocks WHERE notebookTopicPageId IS NOT NULL`)
            .all();
    ...
    `);
        ...
        console.log(`[Migration] Created ${existingBlocks.length} block_topic_assignments for existing blocks`);
        (0, db_connection_1.setSchemaVersion)(24);
    })();
