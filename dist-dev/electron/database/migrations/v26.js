...
exports.migrateToV26 = migrateToV26;
...
function migrateToV26() {
    console.log("[Migration] Starting migration to schema version 26 (Knowledge Archetypes)...");
    ...
    `);
        (0, db_connection_1.setSchemaVersion)(26);
    })();
